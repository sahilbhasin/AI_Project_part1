...
def model():
    ...
    print("this is conv 2", conv2)
    print("this is pool2 ", pool2)
    ...
    with tf.variable_scope('conv5') as scope:
        ...
        print("this is convolve 5 ",conv5)
    ...
    with tf.variable_scope('fully_connected1') as scope:
        ...
        print("this is reshape value ",reshape)
        print(" this is dim",dim)
        print("value of FCC 1",local3)
